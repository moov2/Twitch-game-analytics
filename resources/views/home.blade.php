            ...
            <div class="row">
                ...
                <div class="card col-lg-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">Top streams of last 7 days, based on peak viewers.</p>
                    </div>
                    <ul class="list-group list-group-flush">
                        @foreach ($topStreams as $stream)
                        <li class="list-group-item">{{$stream->user_name}} <span class="badge badge-info float-right">{{number_format($stream->sum)}}</span></li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="card col-lg-3">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">{{$stream->user_name}} <span class="badge badge-info float-right">{{gmdate("H:i", $stream->date_diff)}}</span></li>
                        @endforeach
                    </ul>
                </div>
